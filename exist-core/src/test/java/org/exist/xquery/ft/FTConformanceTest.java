...
public class FTConformanceTest {
    ...
    public void s2_4_orderedReverse() throws Exception {
        // "fox" before "quick" — ordered filter should still pass because
        // our cross-product stores positions, and sorted positions are always ascending
        // Actually this tests whether ftand('fox', 'quick') ordered works
        assertTrue(evalBool(
    ...
    public void s2_5_lowercase() throws Exception {
        // "lowercase" converts both source and search to lowercase before comparing
