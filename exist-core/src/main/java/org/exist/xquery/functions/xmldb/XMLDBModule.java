...
public class XMLDBModule extends AbstractInternalModule {
    ...
    public final static FunctionDef[] functions = {
            ...
            new FunctionDef(XMLDBGetChildCollections.signatures[0], XMLDBGetChildCollections.class),
            new FunctionDef(XMLDBGetChildCollections.signatures[1], XMLDBGetChildCollections.class),
            new FunctionDef(XMLDBGetChildResources.signatures[0], XMLDBGetChildResources.class),
            new FunctionDef(XMLDBGetChildResources.signatures[1], XMLDBGetChildResources.class),
