...
public class ErrorCodes {
    ...
    public static final ErrorCode XQST0106 = new W3CErrorCode("XQST0106", "It is a static error if a function's annotations contain more than one annotation named %public or %private, or if they contain both %public and %private.");
    public static final ErrorCode XQST0116 = new W3CErrorCode("XQST0116", "It is a static error if a variable declaration's annotations contain more than one annotation named %public or %private, or if they contain both %public and %private.");
    ...
    public static final ErrorCode FOTY0014 = new W3CErrorCode("FOTY0014", "The argument to fn:string() is a function item.");
